            ...
            <div className="container background-login">
                ...
                <div className="form-section">
                    ...
                    <form className="form">
                        ...
                        <p className="body-two text-center"><a href="#">Forgot your password?</a></p>
                    </form>
                </div>

                <div className="account-select">
                    <p className="body-two text-light text-center">  Don't have an account yet?
                        <a href="./signup">Create one</a>
                    </p>
                </div>

                <div className="text-center">
                    <img className="illustration-sign-in" src={require("../website_images/sign-in.png")} alt="Sign Up" />
                </div>
            </div>
        </section>
    );
